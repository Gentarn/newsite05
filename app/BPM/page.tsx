    ...
    <div className="flex flex-col min-h-screen bg-white text-gray-800">
      ...
      <main className="flex-grow pt-[72px]"> {/* ヘッダーの高さ分パディングを追加 */}
        <div className="container mx-auto py-8">
          <h1 className="text-3xl font-bold mb-8">BPM (Business Process Management)</h1>
          <Card className="p-6">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h2 className="text-2xl font-semibold mb-4">ビジネスプロセス管理ソリューション</h2>
                <p className="mb-4">
                  当社のBPMソリューションは、業務プロセスの可視化、標準化、自動化を実現します。
                </p>
